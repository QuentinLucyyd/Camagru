<?php
	...
	if (!isset($_SESSION['username']))
		...
		if (isset($_POST['edit-submit'])){
			...
			$query = "UPDATE users SET first_name=:first_name, last_name=:last_name, user_name=:username, user_email=:email, email_pref=:email_pref WHERE user_id=:id";
...
<h3 class="white">Edit:</h3>
	<form name="edit-form" method="post">
		...
		<input type="checkbox" name="email_preference" value="pref_on">Do not send me emails<br>
